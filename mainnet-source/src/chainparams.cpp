...
public:
    CMainParams() {
        ...
        consensus.CSVHeight = 6048; // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        ...
        // Parallax forks from Parallax at block 50,000. The fork is enforced when the full block is validated.
        ...
        consensus.defaultAssumeValid = uint256S("0x00"); // Parallax starts from its own genesis block 0
        ...
        genesis = CreateGenesisBlock("Parallax created in 2025", CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG, 1784300250, 513117, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x72b26135d67f262b8f9c33277c4be8499482d3cba475bc36291f6729dea08ae5"));
        assert(genesis.hashMerkleRoot == uint256S("0xf350acf4761d6947161447bde2720fa39e77fb11509ccd7314a0701253e157da"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.emplace_back("141.136.36.227");
        ...
        checkpointData = {
            {
                {0, uint256S("0x72b26135d67f262b8f9c33277c4be8499482d3cba475bc36291f6729dea08ae5")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00");
        consensus.defaultAssumeValid = uint256S("0x00"); // Parallax testnet starts from its own genesis block 0
