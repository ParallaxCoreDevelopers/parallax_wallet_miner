...
static const char* qt_argv = "parallax-qt";
...
void BitcoinApplication::createSplashScreen(const NetworkStyle *networkStyle)
{
    ...
    m_splash->show();
    m_splash->showMessage(QObject::tr("The wallet may take time to load depending on your operating system."), Qt::AlignBottom | Qt::AlignHCenter, Qt::white);
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if(success)
    {
        ...
        // Keep splash visible briefly after initialization so Windows users do not see a frozen main window.
...
int GuiMain(int argc, char* argv[])
{
    ...
    if (!gArgs.IsArgSet("-addnode") && !gArgs.IsArgSet("-connect")) {
        gArgs.ForceSetArg("-addnode", "141.136.36.227:19339");
    }
