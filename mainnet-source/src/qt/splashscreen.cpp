    ...
    QWidget(nullptr, f), curAlignment(0)
{
    ...
    QString versionText     = QString("Version v0.1.3");
    QString copyrightText   = QString::fromUtf8("\xc2\xA9 2025-2026 The Parallax Core developers");
    ...
    QRect rectIcon(QPoint(-15,10), QSize(220,220));
    ...
    // draw copyright stuff
    {
        ...
        QRect loadingRect(x, y + 55, pixmap.width() - x - 20, 70);
        pixPaint.drawText(loadingRect, Qt::AlignLeft | Qt::AlignTop | Qt::TextWordWrap, QString("The wallet may take time to load depending on your operating system."));
    }
