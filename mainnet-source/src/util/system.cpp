...
const char * const BITCOIN_CONF_FILENAME = "parallax.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Parallax";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Parallax";
#else
    // Unix-like
    return pathRet / ".Parallax";
#endif
#endif
}
