...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " parallax-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  parallax-tx [options] <hex-tx> [commands]  Update hex-encoded Parallax transaction\n" +
            "or:     parallax-tx [options] -create [commands]   Create hex-encoded Parallax transaction\n" +
            "\n";
